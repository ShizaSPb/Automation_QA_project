...
class TextBoxPage(BasePage):
    ...
    def fill_all_fields(self):
        self.element_is_visible(self.locators.FULL_NAME).send_keys('asas')
        self.element_is_visible(self.locators.EMAIl).send_keys('asdasd@sad.com')
        self.element_is_visible(self.locators.CURRENT_ADDRESS).send_keys('sdfsdf')
        self.element_is_visible(self.locators.PERMANENT_ADDRESS).send_keys('sdfsdf')
